  ...
  return (
    <main className='w-screen h-screen relative flex flex-col items-center justify-center gap-2 bg-bg-main text-white-200'>
      ...
      <div className='mb-6 flex flex-col w-80 items-center gap-1'>
        ...
        <p className='text-center mt-3'>Recebemos seus dados e em breve enviaremos um e-mail de confirmação!</p>
        <p className='text-sm'>(A confirmação leva, em média, <span className='font-medium'>1 dia útil</span>)</p>
      </div>
