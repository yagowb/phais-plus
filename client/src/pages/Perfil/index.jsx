        ...
        <div className="flex flex-col gap-3 w-full">
          <ProfileDiv title="Informações Gerais">
            <div className="flex gap-12">
              ...
              <ProfileInput label="Nome de Usuário" content={user.username} />

              <ProfileInput label="Identificação" content={user.id} />
          ...
          <ProfileDiv title="Informações de Contato">
            <div className="flex gap-x-12 gap-y-2 flex-wrap">
              <ProfileInput content={user.phone} icon={<Phone size={18} />} />

              <ProfileInput content={user.email} icon={<Mail size={18} />} />
          ...
          <ProfileDiv title="Informações do Sistema">
            <div className="flex gap-12">
              ...
              <ProfileInput
                label="Último Modificação em"
                content={dateTimeFormat.format(new Date(user.updated_at))}
              />
            </div>
            <div>
              <ProfileInput label="Observações" content={user.obs || "-"} />
            </div>
          </ProfileDiv>
        </div>
      </div>
